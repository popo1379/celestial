...
export const metadata: Metadata = {
  title: 'Terms of Service — Celestial',
  description: 'Terms and conditions for using Celestial astrology services.',
  openGraph: {
    title: 'Terms of Service — Celestial',
    description: 'Terms and conditions for using Celestial astrology services.',
  },
...
function t(key: string, locale: string): string {
  const en: Record<string, string> = {
    ...
    'terms.acceptance.content': 'By accessing or using Celestial (the "Service"), you agree to be bound by these Terms of Service. If you disagree with any part of the terms, you may not access the Service.\n\nThese terms apply to all visitors, users, and others who access or use the Service.',
    'terms.service.title': 'Description of Service',
    'terms.service.content': 'Celestial provides astrological chart calculations, daily transit information, synastry analysis, and AI-powered interpretation services. The Service is for entertainment and self-reflection purposes only.',
    ...
    'terms.ip.content': 'The Service and its original content, features, and functionality are and will remain the exclusive property of Celestial and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries.\n\nOur trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Celestial.',
    'terms.disclaimer.title': 'Disclaimer',
    'terms.disclaimer.content': 'ASTROLOGICAL READINGS AND INTERPRETATIONS PROVIDED BY CELESTIAL ARE FOR ENTERTAINMENT AND SELF-REFLECTION PURPOSES ONLY.\n\nThe Service is not a substitute for professional advice, including but not limited to psychological, medical, legal, financial, or career advice. Always seek the advice of qualified professionals regarding any such matters.\n\nWe make no representations or warranties of any kind, express or implied, about the accuracy, reliability, or completeness of the information provided through the Service.',
    ...
    'terms.contact.content': 'If you have any questions about these Terms, please contact us at support@celestial.app.',
  }
  ...
  const zh: Record<string, string> = {
    ...
    'terms.acceptance.content': '访问或使用 Celestial（"服务"）即表示您同意受本服务条款的约束。如果您不同意任何部分条款，则不得访问本服务。\n\n这些条款适用于所有访问或使用服务的访客、用户和其他人。',
    'terms.service.title': '服务描述',
    'terms.service.content': 'Celestial 提供占星图表计算、每日行运信息、合盘分析以及 AI 解读服务。本服务仅供娱乐和自我反思目的使用。',
    ...
    'terms.ip.title': '知识产权',
    'terms.ip.content': '本服务及其原始内容、功能和功能均为 Celestial 及其许可方的专有财产，并且将继续如此。本服务受美国和其他国家的版权、商标和其他法律保护。\n\n未经 Celestial 事先书面同意，我们的商标和商业外观不得与任何产品或服务结合使用。',
    'terms.disclaimer.title': '免责声明',
    'terms.disclaimer.content': 'CELESTIAL 提供的占星解读仅供娱乐和自我反思目的使用。\n\n本服务不能替代专业建议，包括但不限于心理、医疗、法律、财务或职业建议。对于任何此类事项，请始终寻求合格专业人士的建议。\n\n我们不对通过服务提供的信息的准确性、可靠性或完整性作出任何类型的明示或暗示的陈述或保证。',
    ...
    'terms.contact.content': '如果您对本条款有任何疑问，请通过 support@celestial.app 联系我们。',
  }
